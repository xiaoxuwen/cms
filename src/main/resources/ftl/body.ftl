...
<div id="content">
    <div id="content_con">
        ...
        <@indexTopicList indexTopic=ts["1"] titleSize=12 divId="notice" hrefClz="index_link">
            ...
            <#list pics as pic>
                <a href="${pic.linkUrl}" title="${pic.title}"><img
                        src="<%=request.getContextPath()%>/resources/indexPic/${pic.newName}" border="0"/></a>
            </#list>
            </div>
        </div>
        ...
        <@indexTopicList indexTopic=ts["3"] titleSize=31 divId="hdjx" hrefClz="index_link">
            <span class="t_title">${ts["3"].cname}</span><span class="more"><a
                href="channel/${ts['3'].cid}">更多</a></span>
        </@indexTopicList>

        <@indexTopicList indexTopic=ts["4"] titleSize=31 divId="jyky" hrefClz="index_link">
            <span class="t_title">${ts["4"].cname}</span><span class="more"><a
                href="channel/${ts['4'].cid}">更多</a></span>
        </@indexTopicList>
        </div>
