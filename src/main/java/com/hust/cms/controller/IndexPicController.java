...
import com.hust.cms.dto.IndexPicDto;
import com.hust.cms.model.BaseInfo;
import com.hust.cms.model.IndexPic;
import com.hust.cms.service.IAttachmentService;
import com.hust.cms.service.IIndexPicService;
import com.hust.cms.service.IIndexService;
import com.hust.cms.util.JsonUtil;
...
public class IndexPicController {
    ...
    public
    @ResponseBody
    AjaxObj confirmPic(HttpSession session, int x, int y, int w, int h, String newName) {
        AjaxObj ao = new AjaxObj();
        try {
            BaseInfo baseInfo = (BaseInfo) session.getServletContext().getAttribute("baseInfo");
